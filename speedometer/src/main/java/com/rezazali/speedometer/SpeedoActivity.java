package com.rezazali.speedometer;
...
public class SpeedoActivity extends AppCompatActivity implements LocationListener,
        ...
        responseTask.addOnCompleteListener(task -> {
            try{
                ...
                if(e.getStatusCode()== LocationSettingsStatusCodes.RESOLUTION_REQUIRED){
                    ...
                    try{
                        apiException.startResolutionForResult(SpeedoActivity.this,REQUEST_CHECK_SETTINGS);
                    }catch (IntentSender.SendIntentException intentException){
                        Log.i("tag","PendingIntent unable to execute request.");
                    }
                }
                if(e.getStatusCode()==LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE){
                    Toast.makeText(SpeedoActivity.this, "Settings not available", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
