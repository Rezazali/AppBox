...
public class QiblaCompassManager implements SensorEventListener,
    ...
    private final CompassActivity qiblaActivity;
    ...
    public QiblaCompassManager(CompassActivity qiblaActivity) {
    ...
    public void onLocationChanged(Location location)   {
        ...
        try {
            ...
            Toast.makeText(qiblaActivity , R.string.location_get_failed, Toast.LENGTH_LONG).show();
