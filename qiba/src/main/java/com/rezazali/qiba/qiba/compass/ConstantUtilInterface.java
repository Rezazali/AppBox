...
/*
 * This Interface only is responsible for AppConstants. Each class that wants to access these AppConstants can implement this class of use the interface with .operator.
*/
...
public interface ConstantUtilInterface {
    ...
    // These AppConstants are here for usage of Qibla Activity
    ...
    // end of QiblaActivity AppConstants
